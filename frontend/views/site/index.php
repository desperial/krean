    ...
    <div class="sf-overlay">
        <div class="sf-center-content" id="search-wrap">
            <form id="realty-search-form" method="get" action="<?= \yii\helpers\Url::to(['realty/list']) ?>">
                ...
                <h3 class=""><a href="<?=\yii\helpers\Url::to(['/site/contact'])?>" style="color: white; font-weight: bolder; font-size: 3rem">Добавление объектов - бесплатно!</a></h3>
                <div class="search-block row">
                    <div class="mat-div country-wrap col-xs-12 col-sm-6">
                    ...
                    <div class="mat-div type-wrap col-xs-12 col-sm-6">
                    ...
                    <div class="search-ads-field search-ads-field-price col-xs-12 col-sm-6">
                    ...
                    <div class="search-ads-field search-ads-field-area col-xs-12 col-sm-6">
                    ...
                    <div class="dlk-radio btn-group sf-position-center col-xs-12 col-sm-6 text-center">
                    ...
                    <div class="search-button col-xs-12 col-sm-6">
