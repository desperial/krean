var overhillMap = new (function()
{
	...
	this.init = function(options)
	{
		...
		jQuery(window).load(function()
		{
			...
			jQuery.getScript('/web/components/overhill/public/services/map/markerclusterer_compiled.js', function()
			{
				self.construct();
			});
		});
	...
	this.construct = function()
	{
		if (googleMapObject === null)
		{
			...
			{
				var markerIcon = new google.maps.MarkerImage(fenric.url('web/components/overhill/public/services/map/marker.png?v3'), new google.maps.Size(32,50));
				...
				{
					styles: [{url: fenric.url('web/components/overhill/public/services/map/cluster.png?v4'), width: 48, height: 48, textColor: 'white'}]
				});
